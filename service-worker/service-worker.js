...
chrome.webNavigation.onCompleted.addListener(async (details) => {
  ...
  // Check for milestones (1M and 10M)
...
function showCelebration(domain, count) {
  const message = count === 1000000 
    ? `🎉 1 MILLION VISITS! 🎉\n\n${domain} has been visited 1,000,000 times!`
    : `🚀 10 MILLION VISITS! 🚀\n\n${domain} has been visited 10,000,000 times!\n\nYou're a super fan!`;
  ...
  try {
    chrome.notifications.create({
      ...
      console.log('Notification shown (or unavailable):', message);
    });
  } catch (e) {
